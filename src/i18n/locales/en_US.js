...
export default {
  promptBox: {
    ...
    noTagsHint: 'No tags yet, please enter in the input box above or add from tag manager',
    ...
    settings: {
      ...
      startPanelTip:
        'Click Start Panel, after successful startup, the panel page will be automatically opened',
      ...
      selectOptionNetworkTranslaterInfo:
        'The third-party tool used is (only for online translation)',
      ...
      installTranslaterPackageInfo:
        'Currently installing translation library, please do not close the window! Wait for installation to complete',
  ...
  message: {
    ...
    applyToTranslaterFail:
      'Switching to a translation library requires installing a translation library. Please install the translation library first and then apply the settings',
    applyTranslaterSuccess: 'Apply translator successful',
    tranlaterPackageInstallFail:
      'Waiting for installation timeout, please check the background installation status. If the installation is successful, click install again to verify',
    ...
    installPackageFail:
      'Failed to install translation package, please check the background installation status',
  ...
  importDialog: {
    ...
    pleaseFullRequest:
      'Please fill in the information of the first-level and second-level classifications completely',
    ...
    add: 'Add Tag',
    pleaseMainCebUuid:
      'The original UUID of the first-level division is only required for incremental updates and cannot be modified',
    pleaseSubGroupUuid:
      'The secondary division of the original UUID is only required for incremental updates and cannot be modified',
  ...
  randomUtils: {
    ...
    totalTags:
      'Random Tag Total Number (If the rule range exceeds the total quantity, the maximum range is calculated by the total quantity)',
    rules: 'Rules',
    addRule: 'Add Rule',
    rule: 'Rule',
    range: 'Range',
    ...
    rulesReminder:
      'Reminder: The range of the first rule must start at 1! If the range exceeds the total number of random, it will simply display all not random!'
  },
  danbooruManager: {
