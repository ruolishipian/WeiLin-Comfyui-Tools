  ...
  <div class="ai-server-setting-panel">
    <div class="weilin-comfyui-translater-setting-box">
      <div class="weilin-comfyui-setting-item">
        ...
        <input
          type="text"
          v-model="aiServerSettingData.api_key"
      ...
      <div class="weilin-comfyui-setting-item">
        <label>AI平台</label>
        <select
          v-model="aiServerSettingData.base_url"
          disabled
          class="weilin-comfyui-common-select"
        >
      ...
      <div class="weilin-comfyui-setting-item">
        ...
        <div style="display: flex; gap: 10px">
          <select
            v-model="aiServerSettingData.model"
            class="weilin-comfyui-common-select"
            style="flex: 1"
          >
          ...
          <button
            type="button"
            class="weilin-comfyui-install-button"
      ...
      <button class="weilin-comfyui-save-button" @click="updateAiServerSettingFunc">
        保存AI平台设置
      </button>
    </div>
    <div class="weilin-comfyui-translater-setting-box">
