<template>
    ...
    <div class="settings-content">
      <div class="info-links">
        <div class="info-link-item">
          ...
          <a
            href="https://www.bilibili.com/list/288025756/?sid=4690314&spm_id_from=333.1387.0.0&oid=114342431298474&bvid=BV1txdfYxE7X"
            target="_blank"
            class="info-link"
          >
        ...
        <div class="info-link-item">
          ...
          <a
            href="https://github.com/weilin9999/WeiLin-Comfyui-Tools-Prompt"
            target="_blank"
            class="info-link"
          >
        ...
        <div class="info-link-item">
          ...
          <a
            href="https://weilin9999.github.io/WeiLin-Share-Prompt-Web/#/"
            target="_blank"
            class="info-link"
          >
      ...
      <div style="margin-bottom: 16px">
        ...
        <button style="margin-left: 10px" @click="triggerFileUpload" class="upload-btn">
          {{ t('importDialog.uploadSQL') }}
        </button>
        <button style="margin-left: 10px" @click="openSelectGroup">
          {{ t('importDialog.selectGroup') }}
        </button>
        <button style="margin-left: 10px" @click="exportSQL">
          {{ t('importDialog.dumpSQL') }}
        </button>
        <button style="margin-left: 10px" @click="exportOnlyTagSQL">
          {{ t('importDialog.dumpOnlySQL') }}
        </button>
      ...
      <div style="margin-bottom: 16px">
        ...
        <button @click="generateGroupSQL">
          {{ t('importDialog.setMainCeb') }}
        </button>
        <input
          style="width: 300px; margin-left: 10px"
          v-model="mainClassUUID"
          :placeholder="t('importDialog.pleaseMainCebUuid')"
        />
      </div>
      <div style="margin-bottom: 16px">
        <input v-model="subGroupName" :placeholder="t('importDialog.pleaseSubGroup')" />
        <button @click="generateSubGroupSQL">
          {{ t('importDialog.setSubCeb') }}
        </button>
        <input
          style="width: 300px; margin-left: 10px"
          v-model="subGroupUUID"
  ...
  <TagGroupSelectDialog ref="tagGroupSelectDialogItem" @sure-select="sureToSelectInfo" />
</template>
