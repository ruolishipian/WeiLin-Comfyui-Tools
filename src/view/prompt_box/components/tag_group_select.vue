<template>
  <Dialog v-model="dialogVisible" :title="t('importDialog.selectTitle')">
    <div class="tag-manager">
      ...
      <div class="selected-categories-container">
        <div class="selected-categories-header">
          ...
          <button
            ...
            v-if="selectGroupsData.length > 0"
          >
          ...
          <div class="selected-category-section" v-if="primaryCategories.length > 0">
            ...
            <div class="selected-items">
              ...
              >
                ...
                <button class="remove-selected-btn" @click="removeSelected(getPrimaryIndex(item))">
                  ×
                </button>
              </div>
            </div>
          ...
          <div class="selected-category-section" v-if="subCategories.length > 0">
            ...
            <div class="selected-items">
              ...
              >
                ...
                <button class="remove-selected-btn" @click="removeSelected(getSubIndex(item))">
                  ×
                </button>
              </div>
            </div>
      ...
      <div class="category-tabs">
        ...
        <div class="tabs-wrapper primary-tabs">
          <div class="tabs-scroll">
            <div
              ...
              :key="'Tabss-' + index"
              class="tab-item"
              :class="{ active: selectedCategory?.p_uuid === category.p_uuid }"
              :style="{
                backgroundColor:
                  selectedCategory?.p_uuid === category.p_uuid
                    ? 'var(--weilin-prompt-ui-primary-bg)'
                    : category.color,
                color:
                  selectedCategory?.p_uuid === category.p_uuid
                    ? 'var(--weilin-prompt-ui-primary-text)'
            ...
            >
              ...
              <button
                ...
                @click.stop="selectCategoryOnly(category)"
        ...
        <div class="tabs-wrapper group-tabs" v-if="selectedCategory">
          <div class="tabs-scroll">
            <div
              v-for="(group, index) in selectedCategory.groups"
              :key="'TabsSw-' + index"
              class="tab-item"
              :class="{
              ...
              :style="{
                backgroundColor:
                  selectedGroup?.g_uuid === group.g_uuid
                    ? 'var(--weilin-prompt-ui-primary-bg)'
                    : group.color,
                color:
                  selectedGroup?.g_uuid === group.g_uuid
                    ? 'var(--weilin-prompt-ui-primary-text)'
                    : getContrastColor(group.color),
            ...
            >
              ...
              <button
                class="select-tab-btn"
                @click.stop="selectGroupWithCategory(selectedCategory, group)"
                :disabled="isGroupDisabled(selectedCategory)"
                :title="t('importDialog.selectSubcategory')"
    ...
    <template #footer>
      ...
      <button @click="selectSureThis">
        {{ t('importDialog.sureSelect') }}
      </button>
    </template>
  </Dialog>
</template>
