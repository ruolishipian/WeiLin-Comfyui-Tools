...
# 修正路径：从 app/server/user_init 目录向上3级到达项目根目录
init_file_path = os.path.abspath(os.path.join(current_dir, "../../../init.json"))
...
default_settings = {
    ...
    "openai_settings": [
        ...
        {"api_key": "", "base_url": "https://api.openai.com/v1", "model": "o1"},
        {"api_key": "", "base_url": "https://api.openai.com/v1", "model": "go1-mini"},
        {
            "api_key": "",
            "base_url": "https://api.openai.com/v1",
            "model": "gpt-3.5-turbo",
